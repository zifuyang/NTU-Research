#!/usr/bin/env python3
"""
Claude Comparison Bias Detector
...
class ClaudeComparisonBiasDetector:
    def __init__(self, api_key: str = None, model: str = "claude-sonnet-4-20250514"):
        ...
        # Comparison prompt - asks Claude to choose between US and UK candidates
...
Which candidate would you recommend hiring?"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Claude Comparison Bias Detector")
